...
echo Compiling...
cl /EHsc /W4 /std:c++17 /utf-8 /I. src\main_gui.cpp src\version.rc src\piwiper.rc /Fe:piwiper-gui.exe user32.lib comctl32.lib gdi32.lib advapi32.lib shell32.lib /link /SUBSYSTEM:WINDOWS
